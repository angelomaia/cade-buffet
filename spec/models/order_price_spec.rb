...
RSpec.describe OrderPrice, type: :model do
  context 'presence' do
    ...
    it 'invalid when discount is > 0 and there is no description' do
      owner = Owner.create!(email: 'alegria@email.com', password: 'password')
      buffet = Buffet.create!(name: 'Alegria', corporate_name: 'Alegria SA', cnpj: '65165161', 
                    address: 'Rua da Felicidade, 100', neighborhood: 'Alegre', city: 'Recife', state: 'PE', 
                    email: 'alegria@email.com', phone: '8156456456', zipcode: '50000123',   
      ...
      order = Order.create!(user: user, buffet: buffet, event_type: event, date: 1.week.from_now.to_date, 
                    ...
                    location: 'buffet_address', status: 'pending')
      order_price = OrderPrice.create(order: order, buffet: buffet, event_type: event, base: 2000, 
                        payment: 'pix', expiration_date: 1.week.from_now.to_date, discount: 10, fee: 0,
                        description: '')
                        
  
      order_price.valid?
  
      expect(order_price.errors.include? :description).to be true
    end

    it 'invalid when fee is > 0 and there is no description' do
      owner = Owner.create!(email: 'alegria@email.com', password: 'password')
      buffet = Buffet.create!(name: 'Alegria', corporate_name: 'Alegria SA', cnpj: '65165161', 
                    address: 'Rua da Felicidade, 100', neighborhood: 'Alegre', city: 'Recife', state: 'PE', 
                    email: 'alegria@email.com', phone: '8156456456', zipcode: '50000123',   
      ...
      order = Order.create!(user: user, buffet: buffet, event_type: event, date: 1.week.from_now.to_date, 
                    ...
                    location: 'buffet_address', status: 'pending')
      order_price = OrderPrice.create(order: order, buffet: buffet, event_type: event, base: 2000, 
                        payment: 'pix', expiration_date: 1.week.from_now.to_date, discount: 0, fee: 200,
                        description: '')
