...
describe 'Ratings appear in buffet page' do
  ...
  it ', and attached photos appear in buffet page' do
    owner = Owner.create!(email: 'alegria@email.com', password: 'password')
    buffet = Buffet.create!(name: 'Alegria', corporate_name: 'Alegria SA', cnpj: '65165161', 
                  address: 'Rua da Felicidade, 100', neighborhood: 'Alegre', city: 'Recife', state: 'PE', 
                  email: 'alegria@email.com', phone: '8156456456', zipcode: '50000123',   
    ...
    travel 5.months do
      rating = Rating.create!(order: Order.find(4), buffet: buffet, user: user, event_type: event,
                    grade: 4, text: 'Boa festa de casamento')
      rating.photos.attach(io: File.open(Rails.root.join('spec', 'support', 'wedding_1.jpg')), 
                          filename: 'wedding_1.jpg', 
